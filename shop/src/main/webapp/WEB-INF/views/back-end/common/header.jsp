    ...
    <div id="layoutSidenav_nav">
      <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
          ...
          <div class="nav">
            ...
            <div class="collapse" id="collapseCategories" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="${pageContext.request.contextPath}/admin/categories">Danh sách</a>
                <a class="nav-link" href="${pageContext.request.contextPath}/admin/add-category">Thêm</a>
              </nav>
            </div>
            ...
            <div class="collapse" id="collapseProducts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="${pageContext.request.contextPath}/admin/products">Danh sách</a>
                <a class="nav-link" href="${pageContext.request.contextPath}/admin/add-product">Thêm</a>
              </nav>
            </div>
            ...
            <div class="collapse" id="collapseContacts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="${ base }/admin/contacts">Liên hệ</a>
              </nav>
            </div>  
            ...
            <div class="collapse" id="collapseOrders" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="${pageContext.request.contextPath}/admin/sale-orders">Dánh sách</a>
                <a class="nav-link" href="/admin/pending-orders">Chờ xử lý</a>
                <a class="nav-link" href="/admin/delivering-orders">Đang giao</a>
                <a class="nav-link" href="/admin/successful-orders">Đã giao</a>
                <a class="nav-link" href="/admin/canceled-orders">Đã hủy</a>
              </nav>
            </div>  
            ...
            <div class="collapse" id="collapseBlog" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="all-posts.html">Dánh sách bài viết</a>
                <a class="nav-link" href="add-post.html">Thêm</a>
                <a class="nav-link" href="all-posts.html">Bài viết của bạn</a>
                ...
                <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne"
                  ...
                  <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" href="all-blog-categories.html">Dánh sách</a>
                    <a class="nav-link" href="add-blog-category.html">Thêm</a>
                  </nav>
                </div>
              </nav>
            </div>   -->
            ...
            <div class="collapse" id="collapseUsers" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link" href="${ base }/admin/users">Danh sách</a>
                <a class="nav-link" href="${ base }/admin/add-user">Thêm</a>
                <a class="nav-link" href="${ base }/admin/your-profile">Thông tin của bạn</a>
              </nav>
            </div>  
        ...
        <div class="sb-sidenav-footer">
          <div class="small">Người đăng nhập:</div>
          <%= fullname %>
        </div>
      </nav>
    </div>